...
namespace Blog.Web.Migrations
{
    ...
    [Migration("20240308165339_Correction TagEntities Lenght")]
    partial class CorrectionTagEntitiesLenght
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blog.Web.Data.Entities.Identity.UserRoleEntity", b =>
                {
            ...
            modelBuilder.Entity("Blog.Web.Data.Entities.Identity.UserRoleEntity", b =>
                {
                    ...
                    b.HasOne("Blog.Web.Data.Entities.Identity.UserEntity", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Blog.Web.Data.Entities.Identity.UserEntity", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
